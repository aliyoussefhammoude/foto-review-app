            ...
            <div className="loginContainer">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="btnContainer">
                        <div className="btns">
                            <button disabled={loading} id="signIn" className="btn btn-primary mr-1 ml-1 mt-3">LOGIN</button>
                            <Link to="/register"><button disabled={loading} className="btn btn-primary mt-3">Sign up</button></Link>
                        </div>
